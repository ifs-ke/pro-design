...
export function QuoteVariance({ suggested, final }: QuoteVarianceProps) {
    ...
    return (
        <div className="border rounded-lg p-3 bg-muted/40 shadow-inner border-dashed">
            <h4 className="font-semibold mb-2 text-sm flex items-center"><AlertCircle className="size-4 mr-2"/> Price Variance</h4>
            <div className="space-y-1 text-xs">
                ...
                <div className="flex justify-between items-center">
                 ...
                 <div className={`flex justify-between items-center font-semibold pt-1.5 border-t mt-1.5 ${getVarianceStyle(variance.total)}`}>
                    <span>Variance</span>
